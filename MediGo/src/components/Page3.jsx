...
const propertys=["Online Consultant","Social Forum","Always Available","Get Medicine","Choose Best"];
const definations=["Get the best advice at the comfort of your home","Connect with someone like you","Any time, We are here","No need to search, We have got you.","Make the best choice"];
let current=0;
