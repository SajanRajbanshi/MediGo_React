    ...
    return(
        ...
        <div className="glassdiv2" id="glassdiv2">
            ...
            <div style={{display: "flex", justifyContent: "space-between"}}>
                <div className="slogan" id="slogan" style={{fontSize: "2vw", color: "#aaaaaa", width:"fit-content"}}>
                    Your Health our Goal
                </div>
                <div className="tabs" id="tabs">
                    <span className="tab dim" id="tab">Contact</span>
                    <span className="tab dim" id="tab">About</span>
                    <div className="pricing" id="pricing">
                        <span className="tab gradient" id="tab">Pricing</span>
                    </div>
                </div>
            </div>
